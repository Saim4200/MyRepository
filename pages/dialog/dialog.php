...
<div id="popup" style="position: fixed; top: 140px; padding: 20px; left: 50%; margin-left: -220px; z-index: 200; display: none">
    <div style="width: 440px; position: relative; z-index: 1" class="error-dialog">
        <div class="error-dialog-titlebar titlebar1"> <span class="error-dialog-title" id="dialog-title" >Error</span></div>
        <div class="error-dialog-content content1">
