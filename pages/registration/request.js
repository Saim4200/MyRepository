...
$(document).ready(function(){
    ...
    var $validator = $('.wizard-card form').validate({
        ...
        messages: {
            ...
            agreeTerms: "Please check this box"
        },
        ...
        invalidHandler: function(event, validator) {
            ...
            if (errors) {
              var message = errors == 1
                ? 'There is an error (highlighted) in the form.'
                : 'There are ' + errors + ' errors (highlighted) in the form.';
            }
          }        
	});
    jQuery.validator.addMethod("ifAtHome",function(value){
       return tplace != 1 || (tplace == 1 && value.length > 0);
    }, "This field is required if you want tutor at your home");
    
    $('#loadloginform').click(function(e) {
                $(".info-text").text("Login with your credentials");
                $(".sub-text").text("");
                $("#agreeTerms").attr("selected", true);
                 $("#agree").hide();
                $("#isRegistered").val("1");
            });
  	...
  	$('.wizard-card').bootstrapWizard({
        ...
        onNext: function(tab, navigation, index) {
        	...
        	if(!$valid) {
                ...
                var subjects = $(".choices__inner :selected").length;
                if(subjects<1){
