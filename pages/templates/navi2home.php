...
<nav>
                    ...
                    <ul class="main-nav js--main-nav clearfix">
                     <li><a href="pages/profile/profile.php?setprofile=1">
                         <?php 
                    $srcpic='pages/profilepic/'.$_SESSION['id'].'.jpg';
                    if(file_exists($srcpic)){
                        ...
                        <li><a href="pages/notification/notification.php" id="notification">
                            
                          <ion-icon name="notifications-outline" id="notification-1"></ion-icon>
                         
                           
                            </a></li>
                        <li><a href="pages/login/logout.php?setlogout=1">logout</a></li>
                 ...
                 <ion-icon name="menu" onclick="openNav()" style="cursor: pointer;"></ion-icon>
                    ...
                    <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                      ...
                      <div class="overlay-content">
                           ...
                           <a href="pages/login/logout.php?setlogout=1">logout</a>
                           <a href="pages/notification/notification.php"> <ion-icon name="notifications-outline"></ion-icon></a>
                           <a href="pages/profile/profile.php?setprofile=1"><?php 
                    $srcpic='pages/profilepic/'.$_SESSION['id'].'.jpg';
                    if(file_exists($srcpic)){
