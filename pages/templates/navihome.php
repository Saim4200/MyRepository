<nav>
                    ...
                    <ul class="main-nav js--main-nav">
                        ...
                        <li><a href="pages/login/login.php?setlogin=1">LOGIN</a></li>
                 ...
                 <ion-icon name="menu" onclick="openNav()" style="cursor: pointer;"></ion-icon>
                      ...
                      <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
                       <div class="col res-box-1-of-6">
                            ...
                            <div class="col res-box-5-of-6">     
                      <div class="overlay-content">
                           <a href="index.php#about">ABOUT US</a>
                           <a href="index.php#wth">WHY TUTORS HOUSE</a>
                           <a href="index.php#contact">CONTACT US</a>
                            <a href="pages/login/login.php?setlogin=1">LOGIN</a>
                            <a href="pages/registration/sform.php">Find a Tutor</a>
